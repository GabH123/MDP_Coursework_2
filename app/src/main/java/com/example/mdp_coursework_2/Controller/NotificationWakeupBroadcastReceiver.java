...
public class NotificationWakeupBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setContentTitle("Sleep Helper");
        builder.setContentText("You can wake up now! Your wake up time is: " + userSchedule.getTimeIn12HourFormat(UserDataSleepRecord.RECOMMENDED_WAKEUP_TIME));
        builder.setSmallIcon(R.drawable.ic_notif_icons);
        builder.setAutoCancel(true);

        Intent intentGoToSleep = new Intent(context,WakeupModeBroadcastReceiver.class);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context,1,intentGoToSleep,PendingIntent.FLAG_IMMUTABLE);

        builder.addAction(R.drawable.ic_notif_wakeup_action,"Wake up",pendingIntent);
